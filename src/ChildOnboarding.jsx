...
const SlideBody = ({ slideIndex, accent, mascotName, childName }) => {
  ...
  const bodies = [
    ...
    /* 4 journal */     <p style={s}>Write <Hi color={accent}>anything</Hi> on your mind — happy thoughts, tricky days, funny stories. Your journal is <Hi color={accent}>just for you</Hi> and your parent. Writing earns a <BerrySVGSmall/>berry!</p>,
